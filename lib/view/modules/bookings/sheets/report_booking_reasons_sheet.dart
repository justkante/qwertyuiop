...
class ReportBookingReasonsSheet extends ConsumerStatefulWidget {
  const ReportBookingReasonsSheet({super.key});

  @override
  ConsumerState<ReportBookingReasonsSheet> createState() => _ReportBookingReasonsSheetState();
}

class _ReportBookingReasonsSheetState extends ConsumerState<ReportBookingReasonsSheet> {
  ...
  Widget build(BuildContext context) {
    final getReportReasons = ref.watch(fetchReportBookingsReasonsProvider);
