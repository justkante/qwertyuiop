...
class CancelReasonsSheet extends ConsumerStatefulWidget {
  const CancelReasonsSheet({super.key});

  @override
  ConsumerState<CancelReasonsSheet> createState() => _CancelReasonsSheetState();
}

class _CancelReasonsSheetState extends ConsumerState<CancelReasonsSheet> {
  ...
  Widget build(BuildContext context) {
    final getCancelReasons = ref.watch(fetchCancelReasonsProvider);
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                "Reason for Cancelling".toTitleCase(),
