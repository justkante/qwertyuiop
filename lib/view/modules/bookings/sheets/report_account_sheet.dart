...
import 'package:creatify_mobile/view/modules/bookings/sheets/report_reasons_sheet.dart';
import 'package:creatify_mobile/view/modules/showcase-talents/vm/report_account_vm.dart';
...
class ReportCreatorAccountSheet extends ConsumerStatefulWidget {
  final String? userId;
  const ReportCreatorAccountSheet({
    super.key,
    this.userId,
  });

  @override
  ConsumerState<ReportCreatorAccountSheet> createState() => _ReportCreatorAccountSheetState();
}

class _ReportCreatorAccountSheetState extends ConsumerState<ReportCreatorAccountSheet> {
  ...
  Widget build(BuildContext context) {
    final reportAccountLoading = ref.watch(reportCreatorAccountProvider).isLoading;

    ref.listen(reportCreatorAccountProvider, (_, value) {
      if (value is AsyncData) {
        context.pop();
        ToastDialog.showSuccess(
          'You have successfully reported this Creator.\nOur team will review it shortly and get back to you',
          context,
          seconds: 5,
    ...
    return AbsorbPointer(
      absorbing: reportAccountLoading,
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            8.0.height,
            Text(
              "If you believe this user has violated our community guidelines or engaged in inappropriate behaviour, you can report their profile here",
            ...
            TextInputField(
              ...
              onPressed: () async {
                selectedReason = await AppBottomSheet.showBottomSheet(
                  context,
                  widget: const ReportReasonsSheet(),
                );
                ...
                Expanded(
                  ...
                  child: ListenableBuilder(
                      ...
                      builder: (context, child) {
                        ...
                        return MainButton(
                          text: 'Yes, Report',
                          isLoading: reportAccountLoading,
                          color: AppColors.highlightRed,
                          onPressed: isValid
                              ? () {
                                  ref
                                      .read(reportCreatorAccountProvider.notifier)
