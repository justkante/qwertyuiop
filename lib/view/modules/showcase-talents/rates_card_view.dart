...
class RatesCardView extends ConsumerStatefulWidget {
  const RatesCardView({super.key});

  @override
  ConsumerState<RatesCardView> createState() => _RatesCardViewState();
}

class _RatesCardViewState extends ConsumerState<RatesCardView> {
