                  ...
                  child: Row(
                    children: [
                      Expanded(child: _buildSmallBanner('Post a job advert', AppImages.editOutline, const Color(0xFFE0F2F1), const Color(0xFF00BFA5), () {
                        NavigationService.instance.push(const JobsMainView(initialIndex: 2));
                      })),
                      12.0.width,
                    ...
                    children: [
                      ...
                      GridView.count(
                        ...
                        children: [
                          ...
                          MetricCard(label: 'Applications', value: '0', icon: Icons.assignment_outlined, bgColor: const Color(0xFFE3F2FD), iconColor: const Color(0xFF2196F3), onTap: () => NavigationService.instance.push(const JobsMainView(initialIndex: 1))),
